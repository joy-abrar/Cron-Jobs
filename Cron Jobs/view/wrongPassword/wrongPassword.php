...
<head>
	...
	<link rel="icon" href="view/wrongPassword/images/logo.png">
	...
	<link rel="stylesheet" type="text/css" href="view/wrongPassword/style.css?version=1.0">
...
<body>
	...
	<div id="mainBloc">
		...
		<h2 style="color: red">Wrong Password Inserted ! Try Again !</h2>
		<form id="submitForm" method="POST" action="index.php?action=submitThisClientForm">
			<div id="submitFormDiv">
				...
				<input type="text" name="repeatPassword" placeholder="Retype your password here...">
				<br><br>
	...
	<center>
		<div id="loginNow">
		<b>Already an account ? <a href="index.php?action=loginPage">Login Now !</a></b> 
	</center>

	<script type="text/javascript" src="view/wrongPassword/main.js"></script>
</body>
</html>